...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        # 添加前进、后退、停止加载和刷新的按钮
        back_button = QAction(QIcon('static/icons/back.png'), 'Back', self)
        next_button = QAction(QIcon('static/icons/forward.png'), 'Forward', self)
        stop_button = QAction(QIcon('static/icons/close.png'), 'stop', self)
        reload_button = QAction(QIcon('static/icons/refresh.png'), 'reload', self)
